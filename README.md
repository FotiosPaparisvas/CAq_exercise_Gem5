...
- [Μέρος Δεύτερο](##-Μέρος-Δεύτερο)
   - [Βήμα πρώτο](###-Βήμα-πρώτο)
      - [Ερώτημα 1](#p2.s1.q1)
      - [Ερώτημα 2](#p2.s1.q2)
      - [Ερώτημα 3](#p2.s1.q3)
      - [Ερώτημα 4](#p2.s1.q4)
   - [Βήμα Δεύτερο](###-Βήμα-Δεύτερο)
      - [Ερώτημα 1](#p2.s2.q1)
      - [Ερώτημα 2](#p2.s2.q2)
   - [Κόστος](####-Κόστος)
   ...
   * Αν παρατηρήσουμε αυτά τα αρχεία μπορούμε να επαληθεύσουμε τα στοιχεία που έιχε το αρχείο διαμόρφωσης **starter_se.py**.
    ...
    * Όπως αναφέρθηκε προηγουμένως το αρχείο **stats.txt** περιέχει πληροφορίες σχετικά με την εξομοίωση:  
     ...
     * Το συνολικό νούμερο των "_commited_" εντολών ειναι το 
       ...
       ```  
       και είναι ίδιο με το sim_ops kai sim_insts αντίστοιχα που παρουσιάζει ο gem5.//TODO
